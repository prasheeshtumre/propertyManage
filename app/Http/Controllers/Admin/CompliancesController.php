...
class CompliancesController extends Controller
{
    public function store_compliances(Request $request)
    {
        ...
        $occurance = Compliances::where('id','!=',0)->where('property_id', $request->property_id)->first();
        if ($occurance) {
    ...
    public function project_repository(Request $request)
    {
        ...
        $occurance = ProjectRepository::where('id','!=',0)->where('property_id', $request->property_id)->first();
