...
class PropertiesExport implements FromCollection, WithHeadings, WithStyles
{
    ...
    public function __construct($request, $type)
    {
        ...
        $this->subCategories = $request->subCategories;
    ...
    public function collection()
    {
        ...
        $properties
            ...
            ->when($this->subCategories, function ($query) {
                $query->where('commercial_type', $this->subCategories);
            })
        ...
        foreach ($properties as $key => $property) {
            ...
            if ($this->category == 1 || $this->category == 3) {
                ...
                $properties1[$key]['commercial_type'] = $property->CommercialName->cat_name ?? 'N/A';
    ...
    {
        if ($this->category == 1 || $this->category == 3) {
            return ['Date', 'Time', 'GIS ID', 'Category of the Property','Commercial Sub-Type', 'Colony/Locality Name', 'Street Details', 'No of Floors', 'For Rent/Sale', 'Remarks'];
        } elseif ($this->residential_sub_category == 10) {
