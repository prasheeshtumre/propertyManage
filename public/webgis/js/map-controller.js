...
//    console.log(geomBuilding);
    ...
    map.on('singleclick', async (evt) => {
        ...
        var url = apiUrl+"/admin/webgis/handle-click-on-map";
...
//                    });
    ...
    function searchFeature(formData, coordinates = null) {     
            ...
            var urlDestination = apiUrl+"/admin/webgis/get-search-feature";
            ...
            $u.ajaxRequest('POST', urlDestination,
                postData, async function (response) {
                    ...
                    if (Array.isArray(response.message)) {
                        ...
                        if (coordinates === null && isLiveLocation === false) {
                            setTimeout(() =>  {
