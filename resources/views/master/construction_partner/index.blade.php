            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Construction Partner</h4>
                    </div>
                </div>
            </div>
            <!-- end page title -->
            <form action="{{ route('admin.construction_partner.store') }}" method="post" enctype="multipart/form-data"
                class="" id="store-frm">
                @csrf
                <div class="row">
                                ...
                                <div class="col-xl-12 col-md-12">
                                    <div class="row">
                                        <div class="col-md-4 col-lg-4 mt-2">
                                            <label>Enter Construction Partner Name</label>
                                            <input type="text" id="construction_partner" name="construction_partner"
                                                class="form-control" placeholder="Enter Construction Partner Name"
                                                maxlength="100" value="{{ old('construction_partner') }}">

                                            @error('construction_partner')
            ...
            <div class="row">
                <div class="col-xl-12 col-md-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h4 class="mt-0 header-title">Construction Partner</h4>
                            ...
                            <div class="table-responsive" id="pagination_data">
                                ...
                                @include('master.construction_partner.construction_partner_paginate', [
...
@push('scripts')
    ...
    <script>
        ...
        $(document).on('click', '.edit-construction_partner', function() {
            $('#update-frm').show();
            $('#store-frm').hide();
            $('#update-frm').find('input[name="construction_partner"]').val($(this).data('construction_partner'));
            var updateUrl = $(this).data('url');
            $("#update-frm").attr('action', updateUrl);

            // $("#construction_partner").val($(this).data('construction_partner'));
            // var updateUrl = $(this).data('url');
            // $("#store-frm").attr('action', updateUrl);
            // $("#btn-txt").html('Update');
        });
    ...
    <script>
        $(document).ready(function() {
            $('.delete-construction_partner').click(function() {
