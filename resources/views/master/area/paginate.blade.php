...
<div class="ser_re">
    <b class="mb-2">Total Fetched Data : {{ $areas->total() ?? 0 }}</b>
</div>
    ...
    <tbody>
        @forelse ($areas as $area)
            <tr>
                ...
                <td align="center">{{ ($areas->currentPage() - 1) * $areas->perPage() + $loop->iteration }}</td>
                ...
                <td align="center" class="icons-fmain">
                    ...
                    <!-- <a class="icons-f delete-area" data-pid="{{ $area->id }}"
                        data-url="{{ route('admin.area.destroy', $area->id) }}">
