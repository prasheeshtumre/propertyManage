                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xxl-3 col-md-3 mt-3">
                                        ...
                                        <select class="form-select filter_dropdown" name="min_area">
                                    ...
                                    <div class="col-xxl-3 col-md-3 mt-3">
                                        ...
                                        <select class="form-select filter_dropdown" name="max_area">
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-1 row">
                                ...
                                <div class="col-md-12 col-lg-8">
                                    ...
                                    <a class="btn btn-secondary btn-sm ms-1 " id="export_excel" data-format="xlsx"
                                        href="{{ route('admin.ajax.export.excel', [$survey_id, $type]) }}"><i
...
@push('scripts')
    ...
    <script type="text/javascript">
        ...
        $(document).on('click', '#filter-reset', function() {
            var url = "{{ route('admin.surveyor.filter-data', [$survey_id, $type]) }}";
    ...
    <script>
        ...
        $('#show-entries').change(function() {
            ...
            var url = "{{ route('admin.property.reports', $type) }}";
            var append = url.indexOf("?") == -1 ? "?" : "&";
    ...
    <script>
        $(document).on('change', '#fltr_brand_category', function(e) {
            ...
            $.ajax({
                ...
                url: "{{ route('admin.ajax.get-brand-sub-category') }}",
                success: function(response) {
