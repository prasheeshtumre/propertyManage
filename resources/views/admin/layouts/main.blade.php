...
<head>
    ...
    <!--        custom Css-->
    <link href="{{ asset('assets/css/custom.min.css') }}?v=123654" rel="stylesheet" type="text/css" />
    ...
    <div class="global-loader-container ">
        <div class="center-body">
            <div class="loader-circle-9">
                ...
                <img src="{{ url('public/assets/images/konu-icon.svg') }}" alt="" height="30">
                <span></span>
            </div>
        </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="mt-2 text-center">
                            <lord-icon src="{{ asset('assets/js/lordicon/gsqxdxog.json') }}" trigger="loop"
        ...
        <div class="modal fade" id="logout-confirm" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
            ...
            <div class="modal-dialog modal-sm ">
                <div class="modal-content">
                    ...
                    <div class="modal-footer pb-3 d-flex justify-content-center">
