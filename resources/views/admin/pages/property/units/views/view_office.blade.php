...
<link href="{{ asset('assets/css/view-units.css?v=8512') }}" rel="stylesheet" type="text/css" />
<style>
    p {
                ...
                <div class="row">
                    <div class="col-md-9 le-pimg-o-body">
                        <div class="product d-flex justify-content-center shadow-sm rounded">
                            ...
                            <a data-fancybox="gallery" class="w-100 @if ($loop->iteration > 1) d-none @endif " href="{{ config('app.propert') . 'public' . $rec->file_path . '/' . $rec->file_name  }}">
                                <img src="{{ config('app.propert') . 'public' . $rec->file_path . '/' . $rec->file_name  }}" class="img-fluid le-pimg">
                            </a>
                            @endif
                            @empty
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-2">
                                <div class="product shadow-sm rounded">
                                    ...
                                    <a data-fancybox="amenity_images" class="@if ($loop->iteration > 1) d-none @endif" href="{{ config('app.propert') . 'public' . $rec->file_path . '/' . $rec->file_name  }}">
                                        <img src="{{ config('app.propert') . 'public' . $rec->file_path . '/' . $rec->file_name  }}" onerror="this.onerror=null; this.src='{{ $default_img }}'" class="img-fluid ri-pimg">
                                    </a>
                                    @endif
                            ...
                            <div class="col-md-12 mb-2">
                                <div class="product shadow-sm rounded">
                                    ...
                                    <a data-fancybox="interior_images" class="@if ($loop->iteration > 1) d-none @endif" href="{{ config('app.propert') . 'public' . $rec->file_path . '/' . $rec->file_name  }}">
                                        <img src="{{ config('app.propert') . 'public' . $rec->file_path . '/' . $rec->file_name  }}" onerror="this.onerror=null; this.src='{{ $default_img }}'" class="img-fluid ri-pimg">
                                    </a>
                                    @endif
                                    @empty
                            ...
                            <div class="col-md-12 mb-2">
                                <div class="product shadow-sm rounded">
                                    ...
                                    @endphp
                                    <a data-fancybox="floor_plan_images" class="@if ($loop->iteration > 1) d-none @endif" href="{{ config('app.propert') . 'public' . $rec->file_path . '/' . $rec->file_name  }}">
                                        <img @if (in_array($extension, ['jpg', 'jpeg' , 'png' , 'gif' ], true)) src="{{ config('app.propert') . 'public' . $rec->file_path . '/' . $rec->file_name  }}" @elseif($extension=='pdf' ) src="{{ asset('assets/images/svg/default-pdf.svg') }}" @endif onerror="this.onerror=null; this.src='{{ $default_img }}'" class="img-fluid ri-pimg">
                                    </a>
                                    @endif
                                    @empty
                                    <a data-fancybox="amenity_images" class="" href="{{ $default_img }}">
                            ...
                            <div class="col-md-12 mb-2">
                                <div class="product shadow-sm rounded">
                                    ...
                                    $extension = pathinfo($rec->file_path . '/' . $rec->file_name, PATHINFO_EXTENSION);
                                    @endphp
                                    <a data-fancybox="unit_videos" class="@if ($loop->iteration > 1) d-none @endif" href="{{ config('app.propert') . 'public' . $rec->file_path . '/' . $rec->file_name }}">
                                        <img src="{{ $defaultVideoIcon  ?? '' }}" class="img-fluid ri-pimg">
                                    </a>
                                    @empty
                                    <a d class="" href="{{ $defaultVideoIcon }}">
