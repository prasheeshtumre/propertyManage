                                    ...
                                    <div class=" screen visible">
                                        <div class="card1">
                                            ...
                                            <div class="row align-items-center mb-3" id="MinNoOfSeats"
                                                ...
                                                <div class="col-md-4">
                                                    <input type="text" class="form-control" max="5"
                                                        name="min_no_of_seats" id=""
                                                        onkeypress="return isNumber(event)" placeholder="Min no of seats">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row align-items-center mb-3" id="MaxNoOfSeats">
                                                ...
                                                <div class="col-md-4">
                                                    <input type="text" class="form-control" max="5"
                                                        name="max_no_of_seats" onkeypress="return isNumber(event)"
                                                        id="" placeholder="Max no of seats">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row align-items-center mb-3" id="NoOfCabins">
                                                ...
                                                <div class="col-md-4">
                                                    <input type="text" class="form-control" max="5"
                                                        onkeypress="return isNumber(event)" name="no_of_cabins"
                                                        id="" placeholder="No of Cabins">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row align-items-center mb-3" id="MeetingRooms">
                                                ...
                                                <div class="col-md-4">
                                                    <input type="text" class="form-control" max="5"
                                                        name="no_of_meeting_rooms" onkeypress="return isNumber(event)"
                                                ...
                                                <div class="row align-items-start mb-3">
                                                    <div class="col-md-12 mb-3">
                                                        <div class="radio-toolbar">
                                                            <input type="radio" id="bedrooms1" name="staircase"
                                                                value="1">
                                                            <label for="bedrooms1">1</label>
                                                            <input type="radio" id="bedrooms2" name="staircase"
                                                                value="2">
                                                            <label for="bedrooms2">2</label>
                                                            <input type="radio" id="bedrooms3" name="staircase"
                                                                value="3">
                                                            <label for="bedrooms3">3</label>
                                                            <input type="radio" id="bedrooms4" name="staircase"
                                                                value="4">
                                                            <label for="bedrooms4">4</label>
                                                            <div class="extra-bedrooms-block" style="display: none;">
                                                                <input type="radio" id="extra-bedrooms-input"
                                                                    name="staircase" value="">
                        ...
                        <form id="AddImage" method="POST">
                            ...
                            <div class="screen">
                                ...
                                <div class="card3">
                                    <div class="row mt-3 mb-3">
                                        <div class="col-md-4">
                                            <p><b>GIS Id : </b> <span class="project-head"> {{ $property->gis_id }}</span>
                                            </p>
                                        </div>
                                        <div class="col-md-4">
                                    ...
                                    <div class="mt-4 mb-4">
                                        ...
                                        <label class="form-label  mt-3">Add images <span class="text-danger">
                                                *</span></label>
                                        <div class="row" style="display:block;">
                                            <div class="col-xxl-3 col-md-3 mb-3 ">
                                                <div class="form-group">
                                                    ...
                                                    <div class="d-flex justify-content-center flex-column">
                                                        <input type="file" name="gallery_images[]" id="files"
                                                            multiple class="form-control file-input"
                                                            style="display:none;">
                                                        <label for="files"
                                                            class="form-label btn-anima btn-hover hoverfEffect ">
                                                            <span> <i class="fa-solid fa-cloud-arrow-up me-1"></i> Add
                                                                Gallery Images</span></label>
                                                    </div>
                                            ...
                                            <div class="col-xxl-3 col-md-3 mb-3 ">
                                                <div class="form-group">
                                                    ...
                                                    <div class="d-flex justify-content-center flex-column">
                                                        <input type="file" name="amenities_images[]" id="AmenityFiles"
                                                            multiple class="form-control file-input"
                                                            style="display:none;">
                                                        <label for="AmenityFiles"
                                                            class="form-label btn-anima btn-hover hoverfEffect ">
                                                            <span> <i class="fa-solid fa-cloud-arrow-up me-1"></i> Add
                                                                Amenities Images</span></label>
                                                    </div>
                                            ...
                                            <div class="col-xxl-3 col-md-3 mb-3 ">
                                                <div class="form-group">
                                                    ...
                                                    <div class="d-flex justify-content-center flex-column">
                                                        <input type="file" name="interior_images[]" id="InteriorFiles"
                                                            multiple class="form-control file-input"
                                                            style="display:none;">
                                                        <label for="InteriorFiles"
                                                            class="form-label btn-anima btn-hover hoverfEffect ">
                                                            <span> <i class="fa-solid fa-cloud-arrow-up me-1"></i> Add
                                                                Interior Images</span></label>
                                                    </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="d-flex justify-content-center flex-column">
                                                        <input type="file" name="floor_plan_images[]"
                                                            id="FloorPlanFiles" multiple class="form-control file-input"
                                                            style="display:none;">
                                                        <label for="FloorPlanFiles"
                                                            class="form-label btn-anima btn-hover hoverfEffect ">
                                                            <span> <i class="fa-solid fa-cloud-arrow-up me-1"></i> Add
                                                                Floor Plan Images</span></label>
                                                    </div>
