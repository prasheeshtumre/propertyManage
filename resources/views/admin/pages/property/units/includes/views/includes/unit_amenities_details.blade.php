@if (
        ...
        @php $exclude_amenity_arr = [14,13,22]; @endphp
...
<div class="list-single-main-item fl-wrap "  style="@if(!empty($unit_data->unit_amenities) && count($unit_data->unit_amenities) > 4) display:none; @endif">
    <div class="list-single-main-item-title">
    ...
    <div class="list-single-main-item_content fl-wrap">
        <div class="listing-features ">
            <ul>
                <li>
                    <a href="#">
                        <img src="{{ url('public/assets/' . $secondary_level_unit_data->floorType->icon_path) }}" class="img-fluid">
...
@endif
    @if(count($unit_data->unit_amenities) > 4)
