...
<link href="{{ asset('assets/css/view-units.css?v=25') }}" rel="stylesheet" type="text/css" />
<style>
    p {
        margin-bottom: 0px;
    }
    ...
    <div class="container-fluid pm-0">
        ...
        <div class="row">
            <div class="col-12">
                ...
                @elseif(
                $property->cat_id == '2' && $property->residential_type == '7' && $property->residential_sub_type == '10')
                <h4 class="mb-sm-0">Apartment View</h4>
                @elseif(
                $property->cat_id == '2' && $property->residential_type == '8' && $property->residential_sub_type == '12')
...
@endif
<hr class="mb-3">
<h4 class="page-header"><span> Add Images rrr</span></h4>
<div class="mainDiiv">
    ...
    @endforelse
        ...
        <div class="card-footer">
            <div class="ms-auto text-end">
                ...
                @else
                <a href="{{ url('surveyor/property/edit_unit_details/' . $secondary_level_unit_data->unit_id . '/' . $property->residential_type) }}" class=" btn btn-done btn-primary ">Edit &nbsp;<i class=" fa fa-arrow-right"></i></a>
                @endif
            </div>
        </div>
    </div>
