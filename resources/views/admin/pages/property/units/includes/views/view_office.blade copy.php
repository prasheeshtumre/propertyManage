                    ...
                    <div class="mainDiiv">
                        ...
                        @if ($secondary_level_unit_data->office_type == '83')
                            <div class=" ">
                                <div class=" viewbedrooms">
                                    <div>
                                        <img src="{{ url('public/assets/images/Layer_1Minnoofseats.svg') }}"
                                            class="img-fluid">
                                    </div>
                                    <div>
                                        <div>
                            ...
                            <div class=" ">
                                <div class="viewbedrooms">
                                    <div>
                                        <img src="{{ url('public/assets/images/Layer_1Maxnoofseats.svg') }}"
                                            class="img-fluid">
                                    </div>
                                    <div>
                                        <div>
                            ...
                            <div class=" ">
                                <div class="viewbedrooms">
                                    <div>
                                        <img src="{{ url('public/assets/images/Layer_1NoofCabins.svg') }}"
                                            class="img-fluid">
                                    </div>
                                    <div>
                                        <div>
                            ...
                            <div class=" ">
                                <div class="viewbedrooms">
                                    <div>
                                        <img src="{{ url('public/assets/images/Layer_1NoofMeetingRooms.svg') }}"
                                            class="img-fluid">
                                    </div>
                                    <div>
                                        <div>
                            ...
                            <div class="  ">
                                <div class="viewbedrooms">
                                    <div>
                                        <img src="{{ url('public/assets/images/Layer_1ConerenceRoom.svg') }}"
                                            class="img-fluid">
                                    </div>
                                    <div>
                                        <div>
                            ...
                            <div class="  ">
                                <div class="viewbedrooms">
                                    <div>
                                        <img src="{{ url('public/assets/images/Layer_1ReceptionArea.svg') }}"
                                            class="img-fluid">
                                    </div>
                                    <div>
                                        <div>
                            ...
                            <div class="">
                                <div class="viewbedrooms">
                                    <div>
                                        <img src="{{ url('public/assets/images/Layer_1OxygenDust.svg') }}"
                                            class="img-fluid">
                                    </div>
                                    <div>
                                        <div>
                            ...
                            <div class="">
                                <div class="viewbedrooms">
                                    <div>
                                        <img src="{{ url('public/assets/images/Layer_1FireSafetyMeasures.svg') }}"
                                            class="img-fluid">
                                    </div>
                                    <div>
                                        <div>
                ...
                @elseif($property->cat_id == '4' && $property->plot_land_type == '13')
                    <div class="mainDiiv">
                        <div class="">
                            <div class="viewbedrooms">
                                <div>
                                    <img src="{{ url('public/assets/images/Layer_1AddAreaDetails.svg') }}"
                                        class="img-fluid">
                                </div>
                                <div>
                                    <div>
                        ...
                        <div class="">
                            <div class="viewbedrooms">
                                <div>
                                    <img src="{{ url('public/assets/images/GroupPropertyDimensions.svg') }}"
                                        class="img-fluid">
                                </div>
                                <div>
                                    <div>
                        ...
                        <div class="  ">
                            <div class="viewbedrooms">
                                <div>
                                    <img src="{{ url('public/assets/images/Layer_1No ofopenside.svg') }}"
                                        class="img-fluid">
                                </div>
                                <div>
                                    <div>
        ...
        @if ($secondary_level_unit_data->property_cat_id != '6')
            ...
            <div class="mainDiiv">
                ...
                <div class="  ">
                    <div class="viewbedrooms">
                        <div>
                            <img src="{{ url('public/assets/images/Layer_AdditionaPricing.svg') }}"
                                class="img-fluid img-mobile" style="">
                        </div>
                        <div>
                            <div>
                ...
                @if ($secondary_level_unit_data->pricing_details_for == '2')
                    <div class="   ">
                        <div class="viewbedrooms">
                            <div>
                                <img src="{{ url('public/assets/images/Layer_PreferredAgreement.svg') }}"
                                    class="img-fluid">
                            </div>
                            <div>
                                <div>
