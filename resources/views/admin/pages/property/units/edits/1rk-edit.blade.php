            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">One Rk Details </h4>
                    </div>
                </div>
            </div>
            <!-- end page title -->
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row align-items-center mb-2">
                                                <div class="col-md-12 mb-3">
                                                    ...
                                                    <div class="radio-toolbar-text required">
                                                        @if ($onerkdata->pricing_details_for == 1 || $onerkdata->pricing_details_for == 4)
                                                            <input type="radio" id="ForSale"
                                                                name="pricing_details_for"
                                                                @if ($onerkdata->pricing_details_for == 1) checked @endif
                                                                onclick="document.getElementById('Type').value=1"
                                                                value="1">
                                                            <label for="ForSale">For Sale</label>

                                                            <input type="radio" id="ForSold"
                                                                name="pricing_details_for"
                                                                @if ($onerkdata->pricing_details_for == 4) checked @endif
                                                                onclick="document.getElementById('Type').value=4"
                                                                value="4">
                                                            <label for="ForSold">Sold</label>
                                                        @endif
                                                        @if ($onerkdata->pricing_details_for == 2 || $onerkdata->pricing_details_for == 3)
                                                            <input type="radio" id="ForRent"
                                                                name="pricing_details_for"
                                                                @if ($onerkdata->pricing_details_for == 2) checked @endif
                                                                onclick="document.getElementById('Type').value='2'"
                                                                value="2">
                                                            <label for="ForRent">For Rent</label>

                                                            <input type="radio" id="ForRented"
                                                                name="pricing_details_for"
                                                                @if ($onerkdata->pricing_details_for == 3) checked @endif
                                                            ...
                                                            <div class="radio-toolbar-text ownership-input">
                                                                @foreach ($ownerships as $ownership)
                                                                    <input type="radio"
                                                                        ...
                                                                        @if ($onerkdata->ownership == $ownership->id) checked @endif>
                                                                    <label
                                                    ...
                                                    <div class="row align-items-center mb-3">
                                                        <div class="col-md-4">
                                                            <input type="text" maxlength="11"
                                                                oninput="validateNumericInput(event)"
                                                                onkeypress="return event.charCode >= 48 && event.charCode <= 57"
                                                                class="form-control required-sale" id="expected_price"
                                                                value="{{ $onerkdata->expected_price ?? '' }}"
                                                                ...
                                                                <div class="px-0 col-md-3">
                                                                    <select class="form-control sqft__based-on" aria-label="Default select example" name="sqft_based_on">
                                                                        ...
                                                                        @forelse(config('constants.AREA_TYPES') as $key=>$area)
                                                                            <option @if($onerkdata->sqft_based_on == $area['id']) selected @endif value="{{$area['id']}}">{{$area['name']}}</option>
                                                                        @empty 
                                                                        @endforelse
                                                                    </select>
                                                                </div>
                                                        ...
                                                        @foreach ($price_details as $details)
                                                            <div class="col-md-2 simplecheck mb-3">
                                                                <span><input type="checkbox"
                                                                        ...
                                                                        @if (in_array($details->id, $price_details_values)) checked @endif
                                                    ...
                                                    <div class="row">
                                                                        ...
                                                                        <select class="form-select form-control-b0"
                                                                            ...
                                                                            @foreach ($price_details_periods as $period)
                                                                                <option value="{{ $period->id }}"
                                                                                    @if ($onerkdata->maintenance_period == $period->id) selected @endif>
                                                                                    {{ $period->name }}</option>
                                                                            @endforeach
                                                                        </select>
                                                                    </div>
                                                        ...
                                                        <div class="col-md-4 mb-2">
                                                            <input type="text" class="form-control border-none"
                                                                ...
                                                                value="{{ $onerkdata->expected_rental ?? '' }}"
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-4">
                                                                    <input type="text" class="form-control border-none"
                                                                        ...
                                                                        value="{{ $onerkdata->booking_amount ?? '' }}"
                                                                ...
                                                                <div class="col-md-4">
                                                                    <input type="text" class="form-control border-none"
                                                                        ...
                                                                        value="{{ $onerkdata->annual_due_pay ?? '' }}"
                                                                ...
                                                                <div class="col-md-4">
                                                                    <input type="text" class="form-control border-none"
                                                                        ...
                                                                        value="{{ $onerkdata->membership_charge ?? '' }}"
                                            ...
                                            <div class="for-rent">
                                                            ...
                                                            <div class="radio-toolbar-text">
                                                                @foreach ($agreement_types as $type)
                                                                    <input type="radio"
                                                                        ...
                                                                        @if ($onerkdata->agreement_type == $type->id) checked @endif>
                                                                    <label
                                                ...
                                                <div class="rent-details-block">
                                                    ...
                                                    <div class="row align-items-center mb-3">
                                                        <div class="col-md-4">
                                                            <input type="text" class="form-control required-rent"
                                                                id="" maxlength="11"
                                                                oninput="validateNumericInput(event)"
                                                                onkeypress="return event.charCode >= 48 && event.charCode <= 57"
                                                                name="expected_rent"
                                                                value="{{ $onerkdata->expected_rent ?? '' }}"
                                                        ...
                                                        @foreach ($rent_details as $item)
                                                            <div class="col-md-2 simplecheck mb-3">
                                                                <span><input type="checkbox"
                                                                        ...
                                                                        @if (in_array($item->id, $rent_details_values)) checked @endif
                                                ...
                                                <div class="add-rent-details-block">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="row ">
                                                                {{-- <div class="col-md-3">
                                                                    <input type="text" class="form-control " maxlength="11" oninput="validateNumericInput(event)" onkeypress="return event.charCode >= 48 && event.charCode <= 57" value="{{$onerkdata->maintenance_rent ?? ''}}"
                                                                        ...
                                                                        <div class="row d-flex">
                                                                            <div class="col-md-7">
                                                                                <input type="text"
                                                                                    ...
                                                                                    oninput="validateNumericInput(event)"
                                                                                    onkeypress="return event.charCode >= 48 && event.charCode <= 57"
                                                                                    value="{{ $onerkdata->maintenance_rent ?? '' }}"
                                                                                    name="rent_maintenance" id=""
                                                                                    placeholder="Maintenance ">
                                                                            </div>
                                                                            <div class="col-md-5 ms-auto" style=" ">
                                                                ...
                                                                <div class="col-md-3 ">
                                                                    <input type="text" class="form-control  "
                                                                        ...
                                                                        oninput="validateNumericInput(event)"
                                                                        onkeypress="return event.charCode >= 48 && event.charCode <= 57"
                                                                        value="{{ $onerkdata->booking_amount_rent ?? '' }}"
                                                                ...
                                                                <div class="col-md-3 ">
                                                                    <input type="text" class="form-control "
                                                                        ...
                                                                        oninput="validateNumericInput(event)"
                                                                        onkeypress="return event.charCode >= 48 && event.charCode <= 57"
                                                                        value="{{ $onerkdata->annual_dues_rent ?? '' }}"
                                                                ...
                                                                <div class="col-md-3 ">
                                                                    <input type="text" class="form-control"
                                                                        ...
                                                                        oninput="validateNumericInput(event)"
                                                                        onkeypress="return event.charCode >= 48 && event.charCode <= 57"
                                                                        value="{{ $onerkdata->membership_charge_rent ?? '' }}"
                                                        ...
                                                        <div class="col-md-4 mb-3" style="">
                                                            <select class="form-select" name="agreement_durations">
                                                                ...
                                                                @for ($i = 0; $i <= 36; $i++)
                                                                    <option value="{{ $i }}"
                                                                        @if ($onerkdata->agreement_duration == $i) selected @endif>
                                                                        {{ $i }}
                                                            ...
                                                            <div class="radio-toolbar-text">
                                                                @foreach ($notice_months as $item)
                                                                    <input type="radio"
                                                                        ...
                                                                        @if ($onerkdata->notice_period == $item->id) checked @endif>
                                                                    <label
                                            ...
                                            <div class="row align-items-center mb-3" id="RentedDetails"
                                                style="display:none">
                                                <label class="form-label ">Rented Date <span
                                                        style="color:red">*</span></label>
                                                <div class="col-md-4">
                                                    <input type="date" class="form-control" id=""
                                                        value="{{ $onerkdata->rented_date ?? '' }}" name="rented_date"
                                                ...
                                                <div class="col-md-4">
                                                    <input type="text" class="form-control" id=""
                                                        value="{{ $onerkdata->expected_rent ?? '' }}"
                                                        onkeypress="return isNumber(event)" name="rented_price"
                                                        placeholder="Rented Price">
                                                    <span id="err_rented_price"></span>
                                                </div>
                                            </div>

                                            <div class="row align-items-center mb-3" id="SoldPriceDetails"
                                                style="display:none">
                                                <label class="form-label ">Sold Date <span
                                                        style="color:red">*</span></label>
                                                <div class="col-md-4">
                                                    <input type="date" class="form-control" id=""
                                                        value="{{ $onerkdata->rented_date ?? '' }}" name="sold_date"
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <input type="text" class="form-control" id="expected_sold_price"
                                                        maxlength="11" oninput="validateNumericInput(event)"
                                                        onkeypress="return event.charCode >= 48 && event.charCode <= 57"
                                                        name="sold_price" value="{{ $onerkdata->expected_price ?? '' }}"
                                                    ...
                                                    <div class="form-group row">
                                                        <div class="px-0 col-md-3">
                                                            <input type="text" class="form-control" id="sold_price_per_sq_ft" maxlength="11"
                                                                ...
                                                                value="{{ $onerkdata->price_per_sq_ft ?? '' }}"
                                                                placeholder="Price per Sq feet">
                                                        </div>
                                                        <div class="px-0 col-md-3">
                                            ...
                                            <div>
                                                <textarea class="form-control" rows="4" name="remarks_on_property">{{ $onerkdata->remark }}</textarea>
                                            </div>
                                            <div class="card-footer">
                                                <div class="ms-auto text-end">
