                                ...
                                <form id="SubmitPropertyDetails" method="POST">
                                    <div class=" screen visible">
                                        <div class="card1">
                                                        ...
                                                        <select class="form-select" name="office_type" id="TypeOfOffice">
                                                            ...
                                                            @forelse($office_types as $sub_cat)
                                                                <option value="{{ $sub_cat->id }}"
                                                                    @if ($secondary_level_unit_data->office_type == $sub_cat->id) selected @endif>
                                                                    {{ $sub_cat->name }} </option>
                                                            @empty
                                                            @endforelse
                                                        </select>
                                                        ...
                                                        <div class="d-flex">
                                                            <div>
                                                                <input type="text"
                                                                    ...
                                                                    name="super_buildup_area" maxlength="11"
                                                                    id="SuperBuildupArea"
                                            ...
                                            <div class="row align-items-center mb-3" id="MinNoOfSeats"
                                                style="display: none;">
                                                <label class="form-label ">Min no of seats<span
                                                        style="color:red">*</span></label>
                                                <div class="col-md-4">
                                                    <input type="text" maxlength="11"
                                                        oninput="validateNumericInput(event)"
                                                        onkeypress="return event.charCode >= 48 && event.charCode <= 57"
                                                        class="form-control" name="min_no_of_seats"
                                                        value="{{ $secondary_level_unit_data->min_no_of_seats ?? '' }}"
                                                        id="" placeholder="Min no of seats">
                                                </div>
                                            </div>

                                            <div class="row align-items-center mb-3" id="MaxNoOfSeats">
                                                <label class="form-label ">Max no of seats <span
                                                        style="color:red">*</span></label>
                                                ...
                                                <div class="col-md-4">
                                                    <input type="text" maxlength="11"
                                                        oninput="validateNumericInput(event)"
                                                        onkeypress="return event.charCode >= 48 && event.charCode <= 57"
                                                        class="form-control" name="max_no_of_seats" id=""
                                                        value="{{ $secondary_level_unit_data->max_no_of_seats ?? '' }}"
                                                        placeholder="Max no of seats">
                                                </div>
                                            </div>

                                            <div class="row align-items-center mb-3" id="NoOfCabins">
                                                <label class="form-label ">No of Cabins<span
                                                        style="color:red">*</span></label>
                                                ...
                                                <div class="col-md-4">
                                                    <input type="text" maxlength="11"
                                                        oninput="validateNumericInput(event)"
                                                        onkeypress="return event.charCode >= 48 && event.charCode <= 57"
                                                        class="form-control" name="no_of_cabins" id=""
                                                        value="{{ $secondary_level_unit_data->no_of_cabins ?? '' }}"
                                                        placeholder="No of Cabins">
                                                </div>
                                            </div>

                                            <div class="row align-items-center mb-3" id="MeetingRooms">
                                                <label class="form-label ">No of Meeting Rooms<span
                                                        style="color:red">*</span></label>
                                                ...
                                                <div class="col-md-4">
                                                    <input type="text" maxlength="11"
                                                        oninput="validateNumericInput(event)"
                                                        onkeypress="return event.charCode >= 48 && event.charCode <= 57"
                                                        class="form-control" name="no_of_meeting_rooms"
                                                        value="{{ $secondary_level_unit_data->no_of_meeting_rooms ?? '' }}"
                                                        id="" placeholder="No of Meeting Rooms">
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-md-12 mb-3">
                                                    ...
                                                    <div class="radio-toolbar-text">
                                                        @forelse($pantries as $pantry)
                                                            <input type="radio" id="pantry-{{ $pantry->id }}"
                                                                name="pantry"
                                                                @if ($secondary_level_unit_data->pantry == $pantry->id) checked @endif
                                                                value="{{ $pantry->id }}">
                                                            <label
                                                                for="pantry-{{ $pantry->id }}">{{ $pantry->name }}</label>
                                                        @empty
                                                        @endforelse
                                                    </div>
                                            ...
                                            <div class="row align-items-center mb-3" id="ConferenceRoom">
                                                <label class="form-label ">Conference Room<span
                                                        style="color:red">*</span></label>

                                                <div class="col-md-12 mb-3">
                                                    <div class="radio-toolbar-text">
                                                        @forelse($conf_rooms as $conf_room)
                                                            <input type="radio" id="conf_room-{{ $conf_room->id }}"
                                                                @if ($secondary_level_unit_data->conference_room == $conf_room->id) checked @endif
                                                                name="conference_room" value="{{ $conf_room->id }}">
                                                            <label
                                                                for="conf_room-{{ $conf_room->id }}">{{ $conf_room->name }}</label>
                                                        @empty
                                                        @endforelse
                                                    </div>
                                                    ...
                                                    <div class="col-md-12 mb-3">
                                                        <div class="radio-toolbar-text">
                                                            @forelse($receptions as $recep)
                                                                <input type="radio" id="reception-{{ $recep->id }}"
                                                                    @if ($secondary_level_unit_data->reception_area == $recep->id) checked @endif
                                                                    name="reception_area" value="{{ $recep->id }}">
                                                                <label
                                                                    for="reception-{{ $recep->id }}">{{ $recep->name }}</label>
                                                            @empty
                                                            @endforelse
                                                        </div>
                                                        ...
                                                        <div class="col-md-12 mb-3">
                                                            <div class="radio-toolbar-text">
                                                                @forelse($furnishing as $furnish)
                                                                    <input type="radio"
                                                                        id="furnishing-{{ $furnish->id }}"
                                                                        @if ($secondary_level_unit_data->furnishing == $furnish->id) checked @endif
                                                                        name="furnishing" value="{{ $furnish->id }}">
                                                                    <label
                                                                        for="furnishing-{{ $furnish->id }}">{{ $furnish->name }}</label>
                                                                @empty
                                                                @endforelse
                                                            </div>
                                                        ...
                                                        <div class="col-md-12 mb-3">
                                                            <div class="radio-toolbar-text">
                                                                @forelse($central_air_conditions as $central_air_cond)
                                                                    <input type="radio"
                                                                        id="central_air_cond-{{ $central_air_cond->id }}"
                                                                        @if ($secondary_level_unit_data->central_air_conditions == $central_air_cond->id) checked @endif
                                                                        name="central_air_conditions"
                                                                        value="{{ $central_air_cond->id }}">
                                                                    <label
                                                                        for="central_air_cond-{{ $central_air_cond->id }}">{{ $central_air_cond->name }}</label>
                                                                @empty
                                                                @endforelse
                                                            </div>
                                                        ...
                                                        <div class="col-md-12 mb-3">
                                                            <div class="radio-toolbar-text">
                                                                @forelse($oxygen_dust as $oxgn_dst)
                                                                    <input type="radio"
                                                                        id="oxgn_dst-{{ $oxgn_dst->id }}"
                                                                        @if ($secondary_level_unit_data->oxygen_dust == $oxgn_dst->id) checked @endif
                                                                        name="oxygen_dust" value="{{ $oxgn_dst->id }}">
                                                                    <label
                                                                        for="oxgn_dst-{{ $oxgn_dst->id }}">{{ $oxgn_dst->name }}</label>
                                                                @empty
                                                                @endforelse
                                                            </div>
                                                ...
                                                <div class="row align-items-center mb-3">
                                                    <div class="col-md-12 mb-3">
                                                        <div class="col-md-12 mb-3">
                                                            <div class="radio-toolbar-text">
                                                                @forelse($UPS as $upss)
                                                                    <input type="radio" id="upss-{{ $upss->id }}"
                                                                        @if ($secondary_level_unit_data->ups == $upss->id) checked @endif
                                                                        name="ups" value="{{ $upss->id }}">
                                                                    <label
                                                                        for="upss-{{ $upss->id }}">{{ $upss->name }}</label>
                                                                @empty
                                                                @endforelse
                                                            </div>
                                                            <span id="errups"></span>
                                                ...
                                                <div class="row">
                                                    @forelse($fire_safety_masures as $measure)
                                                        <div class="col-md-2 simplecheck mb-3">
                                                            <span><input type="checkbox" value="{{ $measure->id }}"
                                                                    @if (in_array($measure->id, $fire_safety_values)) checked @endif
                                                ...
                                                <div class="row align-items-start  mb-3">
                                                    <div class="col-md-12 mb-3">
                                                        <div class="radio-toolbar" id="AppendStaricase">
                                                            <input type="radio" id="radio20" name="staircase"
                                                                value="1"
                                                                @if ($secondary_level_unit_data->staircase == 1) checked @endif>
                                                            <label for="radio20">1</label>
                                                            <input type="radio" id="radio21" name="staircase"
                                                                value="2"
                                                                @if ($secondary_level_unit_data->staircase == 2) checked @endif>
                                                            <label for="radio21">2</label>
                                                            <input type="radio" id="radio22" name="staircase"
                                                                value="3"
                                                                @if ($secondary_level_unit_data->staircase == 3) checked @endif>
                                                            <label for="radio22">3</label>
                                                            <input type="radio" id="radio23" name="staircase"
                                                                value="4"
                                                                @if ($secondary_level_unit_data->staircase == 4) checked @endif>
                                                            <label for="radio23">4</label>
                                                            @if ($secondary_level_unit_data->staircase > 4)
                                                                <input type="radio" id="bedrooms5" name="staircase"
                                                                    value="{{ $secondary_level_unit_data->staircase }}"
                                                                    checked>
                                                                <label
                                                                    for="bedrooms5">{{ $secondary_level_unit_data->staircase }}</label>
                                                            @endif
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-12 mb-3">
                                                        <div class="radio-toolbar-text">
                                                            @forelse($lifts as $lift)
                                                                <input type="radio" id="lift-{{ $lift->id }}"
                                                                    name="lift"
                                                                    @if ($secondary_level_unit_data->lifts == $lift->id) checked @endif
                                                                    value="{{ $lift->id }}">
                                                                <label
                                                                    for="lift-{{ $lift->id }}">{{ $lift->name }}</label>
                                                            @empty
                                                            @endforelse
                                                        </div>
                                            ...
                                            <div class="row align-items-center mb-3">
                                                <div class="col-md-3">
                                                    <input type="text" placeholder="Owner's Preference"
                                                        value="{{ $secondary_level_unit_data->owners_preference }}"
                                                        name="owners_preference" class="form-control">
                                                </div>
                                            </div>
