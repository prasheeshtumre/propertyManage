                                    ...
                                    <div class="row align-items-center mt-3 mb-3 area-details-block">
                                        ...
                                        <div class="col-md-4 built-area-block" @if ($secondary_level_unit_data->buildup_area == null) style="display: none;" @endif>
                                            <div class="box-bdr">
                                                <div class="d-flex">
                                                    <div>
                                                        <input type="text" maxlength="11" oninput="validateNumericInput(event)" onkeypress="return event.charCode >= 48 && event.charCode <= 57" class="form-control form-control-b0 col-md-3 border-none required-text" value="{{ $secondary_level_unit_data->buildup_area ?? '' }}" name="built_area" id="" placeholder="Add Built up area">
                                                    </div>
                                                    <div class="ms-auto" style="">
                                        ...
                                        <div class="col-md-4 super-built-area-block" @if ($secondary_level_unit_data->super_buildup_area == null) style="display: none;" @endif>
                                            <div class="box-bdr">
                                                <div class="d-flex">
                                                    <div>
                                                        <input type="text" maxlength="11" oninput="validateNumericInput(event)" onkeypress="return event.charCode >= 48 && event.charCode <= 57" class="form-control form-control-b0 col-md-3 border-none required-text" value="{{ $secondary_level_unit_data->super_buildup_area ?? '' }}" name="super_built_area" id="" placeholder="Add Super Built up area">
                                                    </div>
                                                    <div class="ms-auto" style="">
...
<script src="{{ url('public/assets/js/property/units/sqftPriceCalculator.js') }}?v=8525"></script>
<script>
    ...
    $(document).ready(function() {
        ...
        $('form[id=PricingDetailsForm]').submit(function(e) {
            ...
            $.ajax({
                url: "{{ route('surveyor.property.unit_details.resedential.gated_community.store_pricing_details') }}",
                type: 'POST',
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                },
