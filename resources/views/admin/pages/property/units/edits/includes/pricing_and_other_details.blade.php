        ...
        <div class="card1">
            <div class="card-body">
                ...
                <div class="">
                        ...
                        <div class="col-md-12 mb-3">
                            <div class="radio-toolbar-text required">
                                @if ($secondary_level_unit_data->pricing_details_for == 1 || $secondary_level_unit_data->pricing_details_for == 4)
                                    <input type="radio" id="ForSale" name="pricing_details_for"
                                    ...
                                    <input type="radio" id="ForSold" name="pricing_details_for"
                                        @if ($secondary_level_unit_data->pricing_details_for == 4) checked @endif
                                ...
                                @if ($secondary_level_unit_data->pricing_details_for == 2 || $secondary_level_unit_data->pricing_details_for == 3)
                                    <input type="radio" id="ForRent" name="pricing_details_for"
                                    ...
                                    <input type="radio" id="ForRented" name="pricing_details_for"
                                        @if ($secondary_level_unit_data->pricing_details_for == 3) checked @endif
                        ...
                        <div class="col-md-12 mb-3">
                            <div class="radio-toolbar-text">
                                @forelse($ownerships as $owner)
                                    <input type="radio" id="radior{{ $owner->id }}"
                                        @if ($secondary_level_unit_data->ownership == $owner->id) checked @endif name="ownership"
                                        value="{{ $owner->id }}">
                    ...
                    <div class="row align-items-center mb-3" id="PriceDetailsClone" style="display:none">
                        ...
                        <div class="col-md-4">
                            ...
                            <input 
                                ...
                                onkeypress="return event.charCode >= 48 && event.charCode <= 57" name="expected_price" id="expected_price"
                                value="{{ $secondary_level_unit_data->expected_price ?? '' }}"
                                placeholder="Expected Price">
                                <div class="sqft-piw-container">
                                    <p class="truncate-sqft-piw" id="property-price__in_words">
                        ...
                        <div class="col-md-8">
                            <div class="form-group row">
                                ...
                                <input type="text" class="form-control" id="price_per_sq_ft" maxlength="11"
                                    oninput="validateNumericInput(event)"
                                    onkeypress="return event.charCode >= 48 && event.charCode <= 57" name="price_per_sq_ft"
                        ...
                        @forelse($price_details as $price_detail)
                            <div class="col-md-2 simplecheck mb-3">
                                <span><input type="checkbox" name="price_details[]"
                                        @if (in_array($price_detail->id, $price_details_values)) checked @endif
                    ...
                    <div class="row align-items-center mb-3" id="SoldPriceDetails" style="display:none">
                        ...
                        <div class="col-md-4">
                            <input type="date" class="form-control" id=""
                                value="{{ $secondary_level_unit_data->rented_date ?? '' }}" name="sold_date"
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control" id="expected_sold_price" maxlength="11"
                                oninput="validateNumericInput(event)"
                                onkeypress="return event.charCode >= 48 && event.charCode <= 57" name="sold_price"
                                value="{{ $secondary_level_unit_data->expected_price ?? '' }}"
                                placeholder="Expected Price">
                    ...
                    <div class="row" id="AdditionalPrcingDetailsClone" style="display:none">
                            ...
                            <div class="box-bdr">
                                ...
                                <div class="row d-flex">
                                    ...
                                    <div class="col-md-7">
                                        ...
                                        <input type="text" maxlength="11" oninput="validateNumericInput(event)"
                                            onkeypress="return event.charCode >= 48 && event.charCode <= 57"
                                            class="form-control form-control-b0 col-md-3 border-none"
                                            value="{{ $secondary_level_unit_data->mainteinance ?? '' }}"
                                            name="mainteinance" id="" placeholder="Maintenance">
                                        ...
                                        <select class="form-select form-control-b0" name="price_period">
                                            ...
                                            @forelse($price_details_periods as $price_period)
                                                <option value="{{ $price_period->id }}"
                                                    @if ($secondary_level_unit_data->maintenance_period == $price_period->id) selected @endif>
                                                    {{ $price_period->name }}</option>
                                            @empty
                                            @endforelse
                                        </select>
                        ...
                        <div class="col-md-4 mb-2">
                            ...
                            <input type="text" maxlength="11" oninput="validateNumericInput(event)"
                                ...
                                value="{{ $secondary_level_unit_data->expected_rental ?? '' }}"
                                name="expected_rental" id="" placeholder="Expected Rental">
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" maxlength="11" oninput="validateNumericInput(event)"
                                        onkeypress="return event.charCode >= 48 && event.charCode <= 57"
                                        class="form-control border-none" name="booking_amount"
                                        value="{{ $secondary_level_unit_data->booking_amount ?? '' }}" id=""
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" maxlength="11" oninput="validateNumericInput(event)"
                                        onkeypress="return event.charCode >= 48 && event.charCode <= 57"
                                        class="form-control border-none" name="annual_due_pay"
                                        value="{{ $secondary_level_unit_data->annual_due_pay ?? '' }}" id=""
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" maxlength="11" oninput="validateNumericInput(event)"
                                        onkeypress="return event.charCode >= 48 && event.charCode <= 57"
                                        class="form-control border-none" name="membership_charge" id=""
                                        value="{{ $secondary_level_unit_data->membership_charge ?? '' }}"
                        ...
                        <div class="col-md-12 mb-3">
                            <div class="radio-toolbar-text">
                                @forelse($agreement_types as $agrmnt_type)
                                    <input type="radio" id="agrmnt_type-{{ $agrmnt_type->id }}"
                                        @if ($secondary_level_unit_data->agreement_type == $agrmnt_type->id) checked @endif name="agreement_type"
                    ...
                    <div class="row align-items-center mb-3" id="RentedDetails" style="display:none">
                        ...
                        <div class="col-md-4">
                            <input type="date" class="form-control" id=""
                                value="{{ $secondary_level_unit_data->rented_date ?? '' }}" name="rented_date"
                                placeholder="Rented Date">
                        </div>
                        <div class="clearfix mt-3"></div>
                        <label class="form-label ">Rented Price Details <span
                                style="color:red">*</span></label>
                        <div class="col-md-4">
                            <input type="text" class="form-control" id=""
                                value="{{ $secondary_level_unit_data->expected_rent ?? '' }}"
                                onkeypress="return isNumber(event)" name="rented_price" placeholder="Rented Price">
                        </div>
                    </div>
                    ...
                    <div class="row align-items-center mb-3" id="RentDetailsClone" style="display:none">
                        ...
                        <div class="col-md-4">
                            <input type="text" class="form-control" id=""
                                value="{{ $secondary_level_unit_data->expected_rent ?? '' }}"
                                onkeypress="return isNumber(event)" name="expected_rent" placeholder="Expected Rent">
                        </div>

                        <div class="clearfix mt-3"></div>
                        @forelse($rent_details as $facility)
                            <div class="col-md-4 simplecheck mb-3 d-none" id="excludePrice">
                                <span><input type="checkbox" name="facility[]"
                                        @if (in_array($facility->id, $rent_details_values)) checked @endif value="{{ $facility->id }}">
                                    {{ $facility->name }}</span>
                            </div>
                        @empty
                        @endforelse
                    ...
                    <div class="row" id="AdditionalrentDetailClone" style="display:none">
                        ...
                        <div class="col-md-12">
                            <div class="row ">
                                        ...
                                        <div class="row d-flex">
                                            <div class="col-md-7">
                                                <input type="text" class="form-control " maxlength="11"
                                                    oninput="validateNumericInput(event)"
                                                    onkeypress="return event.charCode >= 48 && event.charCode <= 57"
                                                    value="{{ $secondary_level_unit_data->maintenance_rent ?? '' }}"
                                                ...
                                                <select class="form-select form-control-b0" name="maintenance_period">
                                                    ...
                                                    @foreach ($price_details_periods as $period)
                                                        <option value="{{ $period->id }}"
                                                            @if ($secondary_level_unit_data->maintenance_period == $period->id) selected @endif>
                                                            {{ $period->name }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                ...
                                <div class="col-md-3 mb-3">
                                    <input type="text" class="form-control col-md-3 " maxlength="11"
                                        oninput="validateNumericInput(event)"
                                        onkeypress="return event.charCode >= 48 && event.charCode <= 57"
                                        name="booking_amount_rent" id=""
                                        value="{{ $secondary_level_unit_data->booking_amount_rent ?? '' }}"
                                        placeholder="Booking Amount ">
                                </div>
                                ...
                                <div class="col-md-3 mb-3">
                                    <input type="text" class="form-control col-md-3 " maxlength="11"
                                        oninput="validateNumericInput(event)"
                                        onkeypress="return event.charCode >= 48 && event.charCode <= 57"
                                        name="annual_dues_rent" id=""
                                        value="{{ $secondary_level_unit_data->annual_dues_rent ?? '' }}"
                                        placeholder="Annuel Dues Payable  ">
                                </div>
                                ...
                                <div class="col-md-3 mb-3">
                                    <input type="text" class="form-control col-md-3 " maxlength="11"
                                        oninput="validateNumericInput(event)"
                                        onkeypress="return event.charCode >= 48 && event.charCode <= 57"
                                        name="membership_charge_rent" id=""
                                        value="{{ $secondary_level_unit_data->membership_charge_rent ?? '' }}"
                                        placeholder="Membership Charge  ">
                                </div>
                        ...
                        <div class="col-md-4 mb-3" id="AggrementDurationClone" style="display:none">
                            ...
                            <select class="form-select " name="agreement_duration">
                                ...
                                @for ($i = 0; $i <= 36; $i++)
                                    <option value="{{ $i }}"
                                        @if ($secondary_level_unit_data->agreement_duration == $i) selected @endif>{{ $i }}
                        ...
                        <div class="col-md-12 mb-3" id="NoticeMonthClone" style="display:none">
                            ...
                            <div class="radio-toolbar-text">
                                @forelse($notice_months as $notice)
                                    <input type="radio" id="notice-{{ $notice->id }}" name="notice_period"
                                        @if ($secondary_level_unit_data->notice_period == $notice->id) checked @endif
                                        value="{{ $notice->id }}">
            ...
            <div class="card-footer">
                <div class="ms-auto text-end">
                    ...
                    <button type="submit" class="btn btn-done btn-primary">Next &nbsp;<i
