        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    ...
                    <h4 class="mb-sm-0">Edit Individual House</h4>
                    @else
                                ...
                                <div class="screen visible">
                                    ...
                                    <div class="row align-items-start mb-3">
                                        ...
                                        <div class="col-md-2 other-bedrooms-block" style="display: none;">
                                            <input type="text" maxlength="3" class="form-control col-md-3" placeholder="Enter bedrooms" oninput="validateNumericInput(event)" onkeypress="return event.charCode >= 48 && event.charCode <= 57" name="other_bedrooms" id="other-bedrooms">
                                        </div>
                                    ...
                                    <div class="row align-items-start mb-3">
                                        ...
                                        <div class="col-md-2 other-washrooms-block" style="display: none;">
                                            <input type="text" maxlength="3" class="form-control col-md-3" placeholder="Enter washrooms" oninput="validateNumericInput(event)" onkeypress="return event.charCode >= 48 && event.charCode <= 57" name="other_washrooms" id="other-washrooms">
                                        </div>
                                    ...
                                    <div class="row align-items-start mb-3">
                                        ...
                                        <div class="col-md-2 other-balcony-block" style="display: none;">
                                            <input type="text" maxlength="3" class="form-control col-md-3" placeholder="Enter Balconies" oninput="validateNumericInput(event)" onkeypress="return event.charCode >= 48 && event.charCode <= 57" name="other_balconies" id="other-balconies">
                                        </div>
                                    ...
                                    <div class="row align-items-center mt-3 mb-3 area-details-block">
                                        ...
                                        <div class="col-md-4 ">
                                            <div class="box-bdr">
                                                <div class="d-flex">
                                                    <div>
                                                        <input type="text" maxlength="11" class="form-control form-control-b0 col-md-3 border-none required-text" value="{{ $secondary_level_unit_data->carpet_area ?? '' }}" name="carpet_area" id="CarpetArea" placeholder="carpet area">
                                                    </div>
