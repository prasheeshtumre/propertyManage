            ...
            <div class="card">
                    ...
                    <div class="mt-4 mb-4">
                                ...
                                <div class="screen visible">
                                    ...
                                    <div class="row align-items-start mb-3">
                                        ...
                                        <div class="col-md-2 other-bedrooms-block" style="display: none;">
                                            <input type="text" class="form-control col-md-3" placeholder="Enter rooms" maxlength="3" oninput="validateNumericInput(event)" onkeypress="return event.charCode >= 48 && event.charCode <= 57" name="other_rooms_count" id="other-bedrooms">
                                        </div>
                                    ...
                                    <div class="row align-items-start mb-3">
                                        ...
                                        <div class="col-md-2 other-washrooms-block" style="display: none;">
                                            <input type="text" class="form-control col-md-3" placeholder="Enter washrooms" maxlength="3" oninput="validateNumericInput(event)" onkeypress="return event.charCode >= 48 && event.charCode <= 57" name="other_washrooms" id="other-washrooms">
                                        </div>
                                    ...
                                    <div class="radio-toolbar-text">
                                        ...
                                        <input type="radio" id="property_facing{{ $facing->id }}" name="property_facing" @if ($secondary_level_unit_data->property_facing == $facing->id) checked @endif
                                        value="{{ $facing->id }}">
                                    ...
                                    <div class="row align-items-start mb-3">
                                        ...
                                        <div class="col-md-2 other-balcony-block" style="display: none;">
                                            <input type="text" class="form-control col-md-3" placeholder="Enter Balconies" maxlength="3" oninput="validateNumericInput(event)" onkeypress="return event.charCode >= 48 && event.charCode <= 57" name="other_balconies" id="other-balconies">
                                        </div>
                                    ...
                                    <div class="row align-items-center mt-3 mb-3 area-details-block">
                                        ...
                                        <div class="col-md-4 ">
                                            <div class="box-bdr">
                                                <div class="d-flex">
                                                    <div>
                                                        <input type="text" maxlength="11" oninput="validateNumericInput(event)" onkeypress="return event.charCode >= 48 && event.charCode <= 57" class="form-control form-control-b0 col-md-3 border-none required-text" value="{{ $secondary_level_unit_data->carpet_area ?? '' }}" name="carpet_area" id="CarpetArea" placeholder="carpet area">
                                                    </div>
                                                    <div class="ms-auto" style="">
                                                        <select class="form-select form-control-b0 border-left" name="carpet_area_units">
                                                            ...
                                                            <option value="{{ $area_units->id }}" @if ($secondary_level_unit_data->carpet_area_unit == $area_units->id) selected @endif>
                                                                {{ $area_units->name }}
                                                            </option>
                                                            @endforeach
                                                        </select>
                                        ...
                                        <div class="col-md-4 built-area-block" @if ($secondary_level_unit_data->buildup_area == null) style="display: none;" @endif>
                                            <div class="box-bdr">
                                                <div class="d-flex">
                                                    <div>
                                                        <input type="text" maxlength="11" oninput="validateNumericInput(event)" onkeypress="return event.charCode >= 48 && event.charCode <= 57" class="form-control form-control-b0 col-md-3 border-none required-text" value="{{ $secondary_level_unit_data->buildup_area ?? '' }}" name="built_area" id="BuildupArea" placeholder="Add Built up area">
                                                    </div>
                                                    <div class="ms-auto" style="">
                                                        <select class="form-select form-control-b0" name="builtup_area_units">
                                                            @foreach ($area_detail_units as $area_units)
                                                            <option value="{{ $area_units->id }}" @if ($secondary_level_unit_data->buildup_area_unit == $area_units->id) selected @endif>
                                                                {{ $area_units->name }}
                                                            </option>
                                                            @endforeach
                                                        </select>
                                        ...
                                        <div class="col-md-4 super-built-area-block" @if ($secondary_level_unit_data->super_buildup_area == null) style="display: none;" @endif>
                                            <div class="box-bdr">
                                                <div class="d-flex">
                                                    <div>
                                                        <input type="text" maxlength="11" oninput="validateNumericInput(event)" onkeypress="return event.charCode >= 48 && event.charCode <= 57" class="form-control form-control-b0 col-md-3 border-none required-text" value="{{ $secondary_level_unit_data->super_buildup_area ?? '' }}" name="super_built_area" id="SuperBuildupArea" placeholder="Add Super Built up area">
                                                    </div>
                                                    <div class="ms-auto" style="">
                                                        <select class="form-select form-control-b0" name="super_built_area_units">
                                                            @foreach ($area_detail_units as $area_units)
                                                            <option value="{{ $area_units->id }}" @if ($secondary_level_unit_data->super_buildup_area_unit == $area_units->id) selected @endif>
                                                                {{ $area_units->name }}
                                                            </option>
                                                            @endforeach
                                                        </select>
                                    ...
                                    <div class="radio-toolbar-text mt-3">
                                        ...
                                        <div class="col-md-2 simplecheck mb-3">
                                            <span><input type="checkbox" name="other_rooms[]" @if (in_array($room->id, $other_room_values)) checked @endif
                                    ...
                                    <div class="radio-toolbar-text Furn-semi mt-3">
                                        ...
                                        <div>
                                            <input type="radio" id="furnished-option{{ $furnish->id }}" name="furnished_option" @if ($furnish->id == $secondary_level_unit_data->furnishing_option) checked @endif
                                            value="{{ $furnish->id }}">
                                            <label for="furnished-option{{ $furnish->id }}" data-fid="{{ $furnish->id }}" class="toggleItem">
                                                {{ $furnish->name }}</label>
                                            ...
                                            <div id="item{{ $furnish->id }}" class="dropdown-menu p-3 MobilelistFurninshed" style="display: none;">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4  col-6 mb-3">
                                                        <span>
                                                            <input type="checkbox" class="loop-checkboxes" @if (isset($chechkOptions[$option->id])) @if ($option->id == $chechkOptions[$option->id]) checked @endif
                                                            @endif
                                    ...
                                    <div class="radio-toolbar-text">
                                        ...
                                        <input type="radio" class="availability_status_radio" id="availibility_status{{ $availability->id }}" @if ($availability->id == $secondary_level_unit_data->availability_status) checked @endif
                                    ...
                                    <div class="age-of-property-block" @if ($secondary_level_unit_data->availability_status != 23) style="display: none;" @endif>
                                        ...
                                        <div class="radio-toolbar-text">
                                            ...
                                            <input type="radio" id="age_prop{{ $prop->id }}" name="age_of_property" @if ($secondary_level_unit_data->age_of_property == $prop->id) checked @endif
                                            value="{{ $prop->id }}">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row align-items-center mb-2">
                                            <div class="radio-toolbar-text required">
                                                ...
                                                onclick="document.getElementById('Type').value=1"
                                                value="1">
                                                ...
                                                onclick="document.getElementById('Type').value=4"
                                                value="4">
                                                ...
                                                onclick="document.getElementById('Type').value='2'"
                                                value="2">
                                                ...
                                                onclick="document.getElementById('Type').value='3'"
                                                value="3">
                                                ...
                                                {{-- <input type="radio" id="for-sale" value="1"
                                                            @if ($secondary_level_unit_data->pricing_details_for == 1) checked @endif
                                                            name="pricing_details_for">
                                                        <label for="for-sale">For Sale</label>
                                                        <input type="radio" id="for-rent" value="2"
                                                            @if ($secondary_level_unit_data->pricing_details_for == 2) checked @endif
                                                            name="pricing_details_for">
                                        ...
                                        <div class="for-sale">
                                                ...
                                                <div class="row align-items-center mb-2">
                                                    <div class="col-md-12 mb-3">
                                                        <div class="radio-toolbar-text ownership-input">
                                                            ...
                                                            <input type="radio" id="ownership{{ $ownership->id }}" name="ownership" value="{{ $ownership->id }}" @if ($secondary_level_unit_data->ownership == $ownership->id) checked @endif>
                                            ...
                                            <div class="price-details-block">
                                                ...
                                                <div class="row align-items-center mb-3">
                                                    <div class="col-md-4">
                                                        <input type="text" maxlength="11" oninput="validateNumericInput(event)" onkeypress="return event.charCode >= 48 && event.charCode <= 57" class="form-control required-sale" id="expected_price" value="{{ $secondary_level_unit_data->expected_price ?? '' }}" name="expected_price" placeholder="Expected Price">
                                                    ...
                                                    <div class="col-md-8">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="px-0 col-md-3">
                                                                <select class="form-control sqft__based-on" aria-label="Default select example" name="sqft_based_on">
                                                                    <option selected disabled>Area Type</option>
                                                                    @forelse(config('constants.AREA_TYPES') as $key=>$area)
                                                                        <option @if($secondary_level_unit_data->sqft_based_on == $area['id']) selected @endif value="{{$area['id']}}">{{$area['name']}}</option>
                                                                    @empty 
                                                                    @endforelse
                                                                </select>
                                                            </div>
                                                    ...
                                                    <div class="col-md-2 simplecheck mb-3">
                                                        <span><input type="checkbox" name="price_details_{{ $details->id }}" @if (in_array($details->id, $price_details_values)) checked @endif
                                            ...
                                            <div class="add-price-details-block">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <div class="box-bdr">
                                                            <div class="row d-flex">
                                                                <div class="col-md-7">
                                                                    <input type="text" maxlength="11" oninput="validateNumericInput(event)" onkeypress="return event.charCode >= 48 && event.charCode <= 57" class="form-control form-control-b0 border-none" name="pricing_maintenance_price" id="" value="{{ $secondary_level_unit_data->mainteinance ?? '' }}" placeholder="Maintenance">
                                                                </div>
                                                    ...
                                                    <div class="col-md-4 mb-2">
                                                        <input type="text" class="form-control border-none" maxlength="11" oninput="validateNumericInput(event)" onkeypress="return event.charCode >= 48 && event.charCode <= 57" name="pricing_expected_rental" id="" value="{{ $secondary_level_unit_data->expected_rental ?? '' }}" placeholder="Expected Rental">
                                                    </div>

                                                    <div class="col-md-8">
                                                        <div class="row">
                                                            <div class="col-md-4">
                                                                <input type="text" class="form-control border-none" maxlength="11" oninput="validateNumericInput(event)" onkeypress="return event.charCode >= 48 && event.charCode <= 57" name="pricing_booking_amount" id="" value="{{ $secondary_level_unit_data->booking_amount ?? '' }}" placeholder="Booking Amount">
                                                            </div>
                                                            <div class="col-md-4">
                                                                <input type="text" class="form-control border-none" maxlength="11" oninput="validateNumericInput(event)" onkeypress="return event.charCode >= 48 && event.charCode <= 57" name="pricing_annual_dues_payable" id="" value="{{ $secondary_level_unit_data->annual_due_pay ?? '' }}" placeholder="Annual dues payble">
                                                            </div>
                                                            <div class="col-md-4">
                                                                <input type="text" class="form-control border-none" maxlength="11" oninput="validateNumericInput(event)" onkeypress="return event.charCode >= 48 && event.charCode <= 57" name="pricing_membership_charge" id="" value="{{ $secondary_level_unit_data->membership_charge ?? '' }}" placeholder="Membership Charge">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="for-rent">
                                                ...
                                                <div class="row align-items-center mb-2">
                                                    <div class="col-md-12 mb-3">
                                                        <div class="radio-toolbar-text">
                                                            ...
                                                            <input type="radio" id="agreement_type{{ $type->id }}" name="agreement_type" value="{{ $type->id }}" @if ($secondary_level_unit_data->agreement_type == $type->id) checked @endif>
                                            ...
                                            <div class="rent-details-block">
                                                ...
                                                <div class="row align-items-center mb-3">
                                                    <div class="col-md-4">
                                                        <input type="text" class="form-control required-rent" id="" maxlength="11" oninput="validateNumericInput(event)" onkeypress="return event.charCode >= 48 && event.charCode <= 57" name="expected_rent" value="{{ $secondary_level_unit_data->expected_rent ?? '' }}" placeholder="Expected Rent">
                                                    </div>
                                                        ...
                                                        <div class="row ">
                                                            <div class="col-md-4">
                                                                <div class="box-bdr">
                                                                    <div class="row d-flex">
                                                                        <div class="col-md-7">
                                                                            <input type="text" class="form-control " maxlength="11" oninput="validateNumericInput(event)" onkeypress="return event.charCode >= 48 && event.charCode <= 57" value="{{ $secondary_level_unit_data->maintenance_rent ?? '' }}" name="rent_maintenance" id="" placeholder="Maintenance ">
                                                                        </div>
                                                                        <div class="col-md-5 ms-auto" style=" ">
                                                                            <select class="form-select form-control-b0" name="maintenance_period_rent">
                                                                                <option value=""> --select--
                                                                                </option>
                                                                                @foreach ($price_details_periods as $period)
                                                                                <option value="{{ $period->id }}" @if ($secondary_level_unit_data->maintenance_period == $period->id) selected @endif>
                                                            ...
                                                            <div class="col-md-3 ">
                                                                <input type="text" class="form-control  " maxlength="11" oninput="validateNumericInput(event)" onkeypress="return event.charCode >= 48 && event.charCode <= 57" value="{{ $secondary_level_unit_data->booking_amount_rent ?? '' }}" name="rent_booking_amount" id="" placeholder="Booking Amount ">
                                                            </div>
                                                            <div class="col-md-3 ">
                                                                <input type="text" class="form-control " maxlength="11" oninput="validateNumericInput(event)" onkeypress="return event.charCode >= 48 && event.charCode <= 57" value="{{ $secondary_level_unit_data->annual_dues_rent ?? '' }}" name="rent_annual_dues_payable" id="" placeholder="Annual Dues Payable  ">
                                                            </div>
                                                            <div class="col-md-3 ">
                                                                <input type="text" class="form-control" maxlength="11" oninput="validateNumericInput(event)" onkeypress="return event.charCode >= 48 && event.charCode <= 57" value="{{ $secondary_level_unit_data->membership_charge_rent ?? '' }}" name="rent_membership_charge" id="" placeholder="Membership Charge  ">
                                                            </div>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="col-md-4 mb-3" style="">
                                            <select class="form-select" name="agreement_durations">
                                                @for ($i = 0; $i <= 36; $i++) <option value="{{ $i }}" @if ($secondary_level_unit_data->agreement_duration == $i) selected @endif>
                                                    {{ $i }}
                                        ...
                                        <div class="col-md-12 mb-3">
                                            ...
                                            <div class="radio-toolbar-text">
                                                ...
                                                <input type="radio" id="notice_period_{{ $item->id }}" name="notice_period" value="{{ $item->id }}" @if ($secondary_level_unit_data->notice_period == $item->id) checked @endif>
                        ...
                        <div class="row align-items-center mb-3" id="RentedDetails" style="display:none">
                            ...
                            <div class="col-md-4">
                                ...
                                <span id="err_rented_date"></span>
                            </div>
                            <div class="clearfix mt-3"></div>
                            <label class="form-label ">Rented Price Details <span style="color:red">*</span></label>
                            <div class="col-md-4">
                                <input type="text" class="form-control" id="" value="{{ $secondary_level_unit_data->expected_rent ?? '' }}" onkeypress="return isNumber(event)" name="rented_price" placeholder="Rented Price">
                                <span id="err_rented_price"></span>
                            </div>
                        </div>
                        ...
                        <div class="row align-items-center mb-3" id="SoldPriceDetails" style="display:none">
                            ...
                            <div class="col-md-4">
                                ...
                                <span id="err_sold_date"></span>
                            </div>
                            <div class="clearfix mt-3"></div>

                            <label class="form-label ">Price Details <span style="color:red">*</span>
                            </label>
                            <div class="col-md-4">
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="form-group row">
                                    <div class="px-0 col-md-3">
                                        <input type="text" class="form-control" id="sold_price_per_sq_ft" maxlength="11"
                                            oninput="validateNumericInput(event)"
                                            onkeypress="return event.charCode >= 48 && event.charCode <= 57" name="price_per_sqft_sold"
                                            value="{{ $secondary_level_unit_data->price_per_sq_ft ?? '' }}"
                                            placeholder="Price per Sq feet">
                                    </div>
                                    <div class="px-0 col-md-3">
                                        <select class="form-control sold_sqft__based-on" aria-label="Default select example" name="sqft_based_on">
                                            <option selected disabled>Area Type</option>
                                            @forelse(config('constants.AREA_TYPES') as $key=>$area)
                                                <option @if($secondary_level_unit_data->sqft_based_on == $area['id']) selected @endif value="{{$area['id']}}">{{$area['name']}}</option>
                                            @empty 
                        ...
                        <div>
                            <textarea class="form-control" rows="4" name="remarks_on_property">{{ $secondary_level_unit_data->remark }}</textarea>
                        </div>
                        <div class="card-footer">
                            <div class="ms-auto text-end">
                ...
                <form name="AmenitiesForm" method="POST">
                    ...
                    <div class="screen ">
                        <div class="card1">
                            <div class="row mt-3 mb-3">
                                @include('admin.pages.property.units.includes.property_information')Address : </b> <span class="project-head">{{ $property->street_details }}</span></p>
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="mt-4 mb-4">
                                ...
                                <div class="row align-items-center mb-2">
                                    ...
                                    <div class="col-md-2 simplecheck mb-3">
                                        <span>
                                            <input type="checkbox" name="amenity[]" value="{{ $amenity->id }}" @if (in_array($amenity->id, $amenities_values)) checked @endif>
                                            {{ $amenity->name }}
                                        </span>
                                    </div>
                                    @empty
                                ...
                                <div class="row align-items-center mb-2">
                                    ...
                                    <div class="col-md-3 simplecheck mb-3">
                                        <span>
                                            <input type="checkbox" name="society_features[]" value="{{ $loc_advantage->id }}" @if (in_array($loc_advantage->id, $Society_features_values)) checked @endif>
                                            {{ $loc_advantage->name }}
                                        </span>
                                    </div>
                                    @empty
                                ...
                                <div class="row align-items-center mb-2">
                                    ...
                                    <div class="col-md-3 simplecheck mb-3">
                                        <span>
                                            <input type="checkbox" name="additional_features[]" value="{{ $loc_advantage->id }}" @if (in_array($loc_advantage->id, $additional_values)) checked @endif>
                                            {{ $loc_advantage->name }}
                                        </span>
                                    </div>
                                    @empty
                                ...
                                <div class="row align-items-center mb-2">
                                    ...
                                    <div class="col-md-3 simplecheck mb-3">
                                        <span>
                                            <input type="checkbox" name="other_features[]" value="{{ $loc_advantage->id }}" @if (in_array($loc_advantage->id, $other_values)) checked @endif>
                                            {{ $loc_advantage->name }}
                                        </span>
                                    </div>
                                    @empty
                                ...
                                <div class="row align-items-center mb-2">
                                    ...
                                    <div class="col-md-3 simplecheck mb-3">
                                        <span>
                                            <input type="checkbox" name="water_source[]" value="{{ $loc_advantage->id }}" @if (in_array($loc_advantage->id, $water_values)) checked @endif>
                                            {{ $loc_advantage->name }}
                                        </span>
                                    </div>
                                    @empty
                                ...
                                <div class="row align-items-center mb-2">
                                    ...
                                    <div class="col-md-3 simplecheck mb-3">
                                        <span>
                                            <input type="checkbox" name="overlooking[]" value="{{ $loc_advantage->id }}" @if (in_array($loc_advantage->id, $overlooking_values)) checked @endif>
                                            {{ $loc_advantage->name }}
                                        </span>
                                    </div>
                                    @empty
                                ...
                                <div class="row align-items-center mb-2">
                                    ...
                                    <div class="col-md-3 simplecheck mb-3">
                                        <span>
                                            <input type="checkbox" name="power_backup[]" value="{{ $loc_advantage->id }}" @if (in_array($loc_advantage->id, $powerbackup_values)) checked @endif>
                                            {{ $loc_advantage->name }}
                                        </span>
                                    </div>
                                    @empty
                                    ...
                                    <div class="col-md-4 simplecheck mb-3">
                                        <div class="form-group">
                                            <select class="form-select" name="floor_type">
                                                ...
                                                <option value="{{ $unit->id }}" @if ($secondary_level_unit_data->floor_type == $unit->id) selected @endif>
                                                    {{ $unit->name }}
                                                </option>
                                                @empty
                                                @endforelse
                                ...
                                <div class="col-md-4">
                                    <div class="box-bdr">
                                        <div class="d-flex">
                                            <div>
                                                <input type="text" maxlength="11" oninput="validateNumericInput(event)" onkeypress="return event.charCode >= 48 && event.charCode <= 57" class="form-control form-control-b0 col-md-3 border-none" value="{{ $secondary_level_unit_data->facing_road_width ?? '' }}" name="facing_road_width" placeholder="">
                                            </div>
                                            <div class="ms-auto" style="">
                                                <select class="form-select form-control-b0" name="facing_road_width_unit">
                                                    @forelse($width_facing_road_units as $unit)
                                                    <option value="{{ $unit->id }}" @if ($secondary_level_unit_data->facing_road_width_unit == $unit->id) selected @endif>
                                                        {{ $unit->name }}
                                                    </option>
                                                    @empty
                                                    @endforelse
                                ...
                                <div class="row align-items-center mb-2">
                                    ...
                                    <div class="col-md-3 simplecheck mb-3">
                                        <span>
                                            <input type="checkbox" name="location_advantage[]" value="{{ $loc_advantage->id }}" @if (in_array($loc_advantage->id, $location_advantages_values)) checked @endif>
                                            {{ $loc_advantage->name }}
                                        </span>
                                    </div>
                                    @empty
