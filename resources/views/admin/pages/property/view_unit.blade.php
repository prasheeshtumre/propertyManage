...
<div class="col-md-4 mb-3 " >
    <a href="{{url('admin/property/unit_details')}}/{{$unit->id}}" class="active activeCard h-100 card unit-card Unit_MainDetails p-3 {{(in_array($unit->id ,$unit_detail_ids)) ? 'details-found' : 'details-not-found'}}">
        <div class="">
            <div class="">
                            ...
                            @if(($property->cat_id == 3 && $unit->unit_cat_type_id == 1 && $unit->unit_type_id == 2) || in_array($property->cat_id, [1,4,5,6]))
                                ...
                                <div class="Unit_Details"><span>Brand </span> :<span>
                                    ...
                                    @forelse($brands as $unit_category)
                                        ...
                                        @if($unit->unit_brand_id == $unit_category->id) {{$unit_category->name}} @endif
                                        @endif
