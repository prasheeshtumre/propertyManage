...
@section('content')
    @push('css')
        <link href="{{ config('app.propert') }}{{ 'public/assets/css/show-property-details.css' }}?v=345678" rel="stylesheet"
            type="text/css" />
    @endpush
                                        ...
                                        <div class="product d-flex justify-content-center shadow-sm rounded">
                                            @foreach ($property->images->take(1) as $image)
                                                ...
                                                <a data-fancybox="gallery" class="w-100"
                                                    ...
                                                    <img @if (in_array($extension, ['jpg', 'jpeg', 'png', 'gif'], true)) src="{{ config('app.propert') }}{{ 'public/uploads/property/images/' . $image->file_url }}"
                                                            @elseif($extension == 'pdf')
                                                                src="{{ config('app.propert') }}{{ 'public/uploads/property/images/' . $image->file_url }}" @endif
                                                    ...
                                                    <div class="col-md-12 mb-2">
                                                        <div class="product shadow-sm rounded">
                                                            ...
                                                            <a data-fancybox="gallery"
                                                                ...
                                                                <img @if (in_array($extension, ['jpg', 'jpeg', 'png', 'gif'], true)) src="{{ config('app.propert') }}{{ 'public/uploads/property/images/' . $image->file_url }}"
                                                            @elseif($extension == 'pdf')
                                                                src="{{ config('app.propert') }}{{ 'public/uploads/property/images/svg/default-pdf.svg' }}" @endif
