                        ...
                        <div class="card-body ">
                                        ...
                                        <div class="product d-flex justify-content-center shadow-sm rounded">
                                            @foreach ($property->images->take(1) as $image)
                                                ...
                                                <a data-fancybox="gallery" class="w-100"
                                                    ...
                                                    <img @if (in_array($extension, ['jpg', 'jpeg', 'png', 'gif'], true)) src="{{ config('app.propert') }}{{ 'public/uploads/property/images/' . $image->file_url }}" @elseif($extension == 'pdf') src="{{ asset('assets/images/svg/default-pdf.svg') }}" @endif
                                                    ...
                                                    <div class="col-md-12 mb-2 ri-empty-img-body">
                                                        <div
                                                            ...
                                                            <a href="javascript:void;">
                                                                <img src="{{ asset('assets/images/svg/image-na.svg') }}"
                            ...
                            <div class="col-sm-12 col-md-12">
                                                ...
                                                <li class="block-items my-3 card-body clearfix">
                                                    @if ($block->towers->count() > 0)
                                                        @forelse($block->towers->where('no_of_towers','>',0) as $tower)
                                                            ...
                                                            @else
                                                                <div class="block-unit"> <a target="_blank"
                                                                        href="{{ route('admin.property.surveyor.property.unit_details', [$tower->id, $sub_type]) }}">{{ $tower->tower_name }}</a>
                                                                </div>
                                                            @endif
                                                        @empty
                                                        @endforelse
                                ...
                                @if ($property->residential_type == 7)
                                    <div class="accordion-item">
                                        <h2 class="accordion-header property-group-title property-group-block-tower-title"
                                            id="floors-tab">
                                        ...
                                        <div id="collapseThree" class="accordion-collapse collapse"
                                            aria-labelledby="floors-tab" data-bs-parent="#accordionExample">
                            ...
                            <div class="col-sm-12 col-md-12">
                                ...
                                <div class="scrollbar-d" id="project-status-log">
                                    ...
                                    @include(
                                        'admin.pages.property.gated_community.project_status.index_log',
                                                    ...
                                                    @forelse($propertyAmenity->options as $option)
                                                        @if ($property->id == $option->pivot->property_id)
                                                            ...
                                                            <div class="col-md-6 "><span
                                                                    class="mdi mdi-circle-small mdi-18px px-1"></span>{{ $option->name ?? '' }}
                                                            </div>
                                                        @endif
                                                    @empty
                                                    @endforelse
                            ...
                            <div class="col-sm-12 col-md-12 ">
                                ...
                                <div class="row">
                                    @include(
                                        'admin.pages.property.gated_community.compliances.media_files',
                                        [
                            ...
                            <div class="col-sm-12 col-md-12">
                                ...
                                @include(
                                    'admin.pages.property.gated_community.repositories.media_files',
                                    get_defined_vars())
                            </div>
                            <div class="col-sm-12 col-md-12">
                                <h2 class="h4 inline-block heading-medium"> {{ $property->project_name ?? '' }} Price
                                    Trends</h2>
                                @include(
                                    'admin.pages.property.gated_community.price_trends.price_trends_paginate',
                                    get_defined_vars())
...
@push('scripts')
    ...
    <script>
        ...
        $(document).on('click', '#floors-tab', function(e) {
            ...
            $.ajax({
                type: "GET",
                url: "{{ route('admin.property.floors.index') }}",
                data: {
        ...
        $(document).on('change', '#blocks', function(e) {
            ...
            $.ajax({
                type: "GET",
                url: "{{ route('admin.property.get_block_towers') }}",
                data: {
                    block_id: blockId
                },
                success: function(response) {
        ...
        function getPropertyFloors(property_id) {
            ...
            $.ajax({
                ...
                url: "{{ route('admin.property.get_edit_secondary_data_floors') }}",
                data: {
                    c_id: c_id,
                    property_id: property_id,
                    block_id: blockId,
