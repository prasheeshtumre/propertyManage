...
@section('content')
   ...
   .ser_re{
       background-color:#f3e4ff; padding: 5px 10px;
    border-radius: 5px;
   }
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="text-end mt-3">
                                    <button type="button" class="btn btn-primary btn-sm" id="filter-reset">Reset</button>
                                    <button type="button" class="btn btn-primary btn-sm" id="filter"> <i class="fa fa-search"></i> Search</button>
                                </div>
                            </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-center mb-1 row ">
                                ...
                                <div class="col-md-12 col-lg-8">
                                    ...
                                    <a class="btn btn-secondary btn-sm ms-1 " id="export_excel" data-format="xlsx"
                                        href="{{ route('admin.property.export.gated_community_report') }}"><i
                            ...
                            <div class="table-responsive" id="pagination_data">
                                @include('admin.pages.property.gated_community.gated_property_pagination', [
...
@push('scripts')
    ...
    <script type="text/javascript">
        ...
        $(document).on('click', '#filter-reset', function() {
            toggleLoadingAnimation();
            var url = "{{ route('admin.property.gated-reports') }}";
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#category').change(function() {
                ...
                $('.filters-hide').show();
                if (selectedValue == '1') {
                    $("#res-sub-type-blk,#project-blk,#res-type-blk,#owner-blk,#prop-type-blk,#boards-blk,#plot-lands-blk,#plot-name-blk,#const-type-blk")
                        .hide();
                }
                if (selectedValue == '2') {
                    $('.filters-hide').hide();
                ...
                if (selectedValue == '4') {
                    ...
                    $.ajax({
                        type: "GET",
                        url: "{{ route('admin.ajax.get-defined-options') }}",
                        data: {
                            c_id: selectedValue
                        },
                        success: function(response) {
        ...
        $(document).on('change', '.get_subcat_options', function(e) {
            ...
            $.ajax({
                ...
                url: "{{ route('admin.ajax.get-sub-residential') }}",
                success: function(response) {
                    $('#plot_land_types').empty();
