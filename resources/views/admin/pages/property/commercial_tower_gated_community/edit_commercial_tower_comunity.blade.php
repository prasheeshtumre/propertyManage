...
@push('scripts')
    ...
    <script>
        ...
        function getCompliancesBlock() {
            ...
            $.ajax({
                type: "GET",
                url: "{{ route('commercial-tower.compliances.index') }}",
                data: {
                    property_id: property_id
                },
                success: function(response) {
        ...
        function getRepositoryContent(propertyId, blockId, block_tower_id = "") {
            ...
            $.ajax({
                type: "GET",
                url: "{{ route('commercial-tower.repositories.index') }}",
                data: {
                    property_id: propertyId,
                    block_id: blockId,
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('submit', '#CompliancesForm', function(event) {
                ...
                $.ajax({
                    url: "{{ route('commercial-tower.compliances.store-compliances') }}",
                    type: 'POST',
                    data: formData,
                    cache: false,
                    contentType: false,
            ...
            $(document).on('submit', '#ProjectRepositoryForm', function(event) {
                ...
                toggleLoadingAnimation()
                $.ajax({
                    url: "{{ route('commercial-tower.repositories.project-repository') }}",
                    type: 'POST',
                    data: formData,
                    cache: false,
                    contentType: false,
            ...
            $(document).on('submit', '#TowerRepositoryForm', function(event) {
                ...
                $.ajax({
                    url: "{{ route('commercial-tower.repositories.block-tower-repository') }}",
                    type: 'POST',
                    data: formData,
                    cache: false,
                    contentType: false,
