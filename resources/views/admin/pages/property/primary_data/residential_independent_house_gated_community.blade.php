<div class="row residential-independent-house-gated-community residential-fields-child">
    ...
    <div class="col-xxl-3 col-md-3 mt-3">
        ...
        <div class="">
            <input type="text" class="form-control select-suggestions builder-dd" autocomplete="off">
        </div>
    </div>
    <div class="col-xxl-3 col-md-3 mt-3">
    ...
    <div class="col-xxl-3 col-md-3 mt-3">
        <div>
            ...
            <input type="text" value="" name="contact_no" class="form-control is-contact-no" data-valid-length="10" id="">
        </div>
    </div>
    <div class="col-xxl-3 col-md-3 mt-3">
        <div>
