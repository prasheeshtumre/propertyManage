                                        ...
                                        <div class="row residential-apartment-gated-community residential-fields-child">
                                            <div
                                                ...
                                                <div class="col-xxl-3 col-md-3 mt-3">
                                                    ...
                                                    <input type="text" name="subBuilder_name" class="form-control"
                                                        id="" readonly disabled
                                                        value=" {{ $property->subBuilder->name ?? 'N/A' }}">
                                                </div>
                                                <div class="col-xxl-3 col-md-3 mt-3">
                                                    <div>
                                                ...
                                                <div class="col-xxl-3 col-md-3 mt-3">
                                                    <div>
                                                        <label for="" class="form-label">Project Area
                                                            Details</label>
                                                        <input type="text" name="no_of_units" class="form-control"
                                                            id=""
                                                            value="{{ $property->project_area_details ?? '' }}" readonly
                                                            disabled>
                                                    </div>
                                                </div>
                                                <div class="col-xxl-3 col-md-3 mt-3">
                                                ...
                                                <div class="accordion-item">
                                                    <h2 class="accordion-header" id="headingTwo">
                                                        <button class="accordion-button collapsed" type="button"
                                                            ...
                                                            {{ $property->residential_type == config('constants.APARTMENT') ? 'Towers' : 'Units' }}
                                                            @php
                                                                    ...
                                                                    <ul class="block-items clearfix">
                                                                        @if ($block->towers->count() > 0)
                                                                            @forelse($block->towers->where('no_of_towers','>',0) as $tower)
                                                                                ...
                                                                                @else
                                                                                    <li> <a target="_blank"
                                                                                            href="{{ route('admin.property.unit_details', [$tower->id, $sub_type]) }}">{{ $tower->tower_name }}</a>
                                                                                    </li>
                                                                                @endif
                                                                            @empty
                                                                            @endforelse
